...
# # Dados
# texto = ['test SELENIUM by coding on python','lalalalaal','testeee']
...
# nome_midia = 'IMG.jpeg'
# midia_diretorio = os.path.realpath(nome_midia)
...
#     encontrar_usuario(item)
#     enviar_mensagem_encadeada(texto)
#     enviar_imagem(midia_diretorio)
